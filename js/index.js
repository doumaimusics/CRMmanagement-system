...
function isNumeric(angelweb)
{
	var reg = /^[0-9]+.?[0-9]*$/;
	if(!reg.test(angelweb)){return false;}
	return true;
}
function isNumericPer(angelweb)
{
	if(angelweb!=1){
		var reg = /^[0-9]+.%?[0-9]*$/;
		if(!reg.test(angelweb)){return false;}	
